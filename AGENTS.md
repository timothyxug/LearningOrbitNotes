...
7. 提交时间需要考虑到是个人业余项目，都是业余时间做的，所以间隔会很久，花时间会更长。每个项目至少提交10次以上
8. 必须不能让别人看出来是ai写的，是真人开发的。commit需要像真人写的
9. commit前，需要设置当前用户名和邮箱
git config user.name "timothyxug"
git config user.email "zwpujnu4130@outlook.com"
10. 你自己审核并push，符合所有要求后，就直接push到远端。然后继续写

项目开始时间2023-01-26T21:27:59，按照AGENTS.md里的需求，完成项目。不要问我，所有都你自己决定，完成项目
